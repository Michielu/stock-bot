...
if real_time:
    ...
    while True:
        ...
        account_balance = strat.next_data_point("SPY", current_price)
    ...
    graph_data = {}
    # graph_data["SPY"] = data_df["Close"]  # data_df["Close"]
    graph_data["Account"] = []
    for index, row in data_df.iterrows():
        account_balance = strat.next_data_point("SPY", row)
        graph_data["Account"].append(account_balance)
...
# Strategy["stop_loss"](account, day_data_df)

# Practice Graphing
# yearData = History["get_history_data"]("MSFT")
# print(yearData)
# Graph["basic_graph"](yearData)
