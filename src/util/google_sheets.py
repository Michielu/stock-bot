...
class GoogleSheets:
    ...
    def get_values(self):
        ...
        print("Value found: ", self.values_input)

    def write_values(self, new_value):
...
# Creates new spreadsheet .. might not need this
    ...
    def add_sheet(self, init_value, date):
        ...
        try:
            ...
            # self.service.spreadsheets().values().update(spreadsheetId="1MthvI_bns3X3OgZavBZ9ur-u2h3b-8lfkYWB58ahAiU",
            #                                             range='!A1', body=data_i, valueInputOption='RAW').execute()
